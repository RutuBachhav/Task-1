      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
          ...
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
              ...
              <div className='h-full'>
                  {
                    loading ? (
                      <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none className="overflow-hidden" h-full'>
                        {
                      ...
                      <div className='flex gap-2 lg:flex-col overflow-scroll className=overflow-hidden scrollbar-none h-full'>
                        {
